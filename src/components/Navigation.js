    ...
    <nav className="w-full sm:w-2/3 md:w-2/5 align-middle flex flex-row justify-between sm:justify-around gap-x-4 ">
      {user === null && (
        <>
          ...
          <Link className="font-semibold my-auto hover:text-primary-blue" to="/berita">
            Berita
          </Link>
      ...
      {!(user === null) && (
        <>
          ...
          <Link className="font-semibold my-auto hover:text-primary-blue" to="/lesson">
            Lesson
          </Link>
          <Link className="font-semibold my-auto hover:text-primary-blue" to="/download">
            Download
          </Link>
          {/* <Link className="font-semibold my-auto hover:text-primary-blue" to="/dashboard/upload">
            Upload
          </Link> */}
          {/* <Link className="font-semibold my-auto hover:text-primary-blue" to="/learn">
            Learn
